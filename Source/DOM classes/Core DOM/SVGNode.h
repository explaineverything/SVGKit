...
@property(nonatomic,strong,readonly) SVGNodeList* childNodes;
...
@property(nonatomic,strong,readonly) SVGNamedNodeMap* attributes; /**< NB: according to DOM Spec, this is null if the Node is NOT subclassed as an Element */
