...
#import "SVGNamedNodeMap_Iterable.h"

@interface SVGNamedNodeMap()
...
@implementation SVGNamedNodeMap
...
{
	SVGNode* simpleResult = [self.internalDictionary objectForKey:name];
...
-(SVGNode*) setNamedItem:(SVGNode*) arg
{
	...
	SVGNode* oldNode = [self.internalDictionary objectForKey:arg.localName];
...
-(SVGNode*) removeNamedItem:(NSString*) name
{
	...
	SVGNode* oldNode = [self.internalDictionary objectForKey:name];
...
{
	NSMutableDictionary* namespaceDict = [self.internalDictionaryOfNamespaces objectForKey:namespaceURI];
	SVGNode* oldNode = [namespaceDict objectForKey:localName];
...
-(SVGNode*) setNamedItemNS:(SVGNode*) arg inNodeNamespace:(NSString*) nodesNamespace
{
	...
	SVGNode* oldNode = [namespaceDict objectForKey:arg.localName];
...
{
	SVGNamedNodeMap* clone = [[SVGNamedNodeMap allocWithZone:zone] init];
