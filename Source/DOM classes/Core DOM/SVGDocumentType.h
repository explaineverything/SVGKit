...
@interface SVGDocumentType : SVGNode

@property(nonatomic,strong,readonly) NSString* name;
@property(nonatomic,strong,readonly) SVGNamedNodeMap* entities;
@property(nonatomic,strong,readonly) SVGNamedNodeMap* notations;
